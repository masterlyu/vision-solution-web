...
> **코드 현황(2026-09-21 업데이트, VIS-7066):** `blog/page.tsx`와 `blog/[slug]/page.tsx` 모두 TAG_COLORS **104개**로 완전 동기화됨. primary 버킷에 Flowise·AI 이미지 편집·SenseNova U1·포토샵 대안 4건, 앰버 버킷에 모두의AI·4K 상품 사진 2건 추가(VIS-7066). 두 파일 간 내용 일치 확인 완료.
