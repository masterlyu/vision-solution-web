...
> **코드 현황(2026-09-15 업데이트):** `blog/page.tsx`의 `TAG_COLORS`에는 현재 사용 중인 블로그 포스트 태그 20개 전부 명시됨. `blog/[slug]/page.tsx`(포스트 상세)는 향후 확장 대비 ~55개 항목 포함 — 두 파일 간 색상 일관성은 실제 사용 태그 기준으로 유지 중.
