...
| primary (AI·자동화) | AI 활용 · AI 솔루션 · AI 에이전트 · 업무 자동화 · 생성형 AI · 오픈소스 AI · AI 뉴스 · 로컬 AI · **AI 영상** · **소라 대안** · **이미지 생성** · **Google Antigravity** | `primary/10` | `primary` |
...
> **코드 현황(2026-09-21 업데이트, VIS-7046):** `blog/page.tsx`와 `blog/[slug]/page.tsx` 모두 TAG_COLORS **98개**로 완전 동기화됨. primary 버킷에 'Google Antigravity' 1건 추가(VIS-7046, 블로그 포스트 VIS-7030 발행분). 두 파일 간 내용 일치 확인 완료.
