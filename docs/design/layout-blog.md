...
> VIS-5966 루틴 산출물 | AI 디자이너 작성 | 2026-09-01 | 태그 현황 업데이트 2026-09-15 (VIS-6729) | 앰버 버킷 정정·코드 현황 갱신 2026-09-15 (VIS-6758) | primary 버킷 신규 태그 3건·수치 정정 2026-09-16 (VIS-6769) | [slug] 수량 오기 정정 61개 2026-09-16 (VIS-6783) | [slug] 신규 태그 29건 추가 90개 2026-09-17 (VIS-6834) | [slug] 신규 태그 3건 추가 93개 2026-09-17 (VIS-6848) | [slug] 신규 태그 2건 추가 95개 2026-09-17 (VIS-6868)
...
> **코드 현황(2026-09-17 업데이트):** `blog/page.tsx`의 `TAG_COLORS`에는 현재 사용 중인 블로그 포스트 필터 태그 21개 전부 명시됨. `blog/[slug]/page.tsx`(포스트 상세)는 보조 태그 포함 95개 항목(신규 2건 추가: primary 2 — AI 영상·소라 대안) — 두 파일 간 색상 일관성은 실제 사용 태그 기준으로 유지 중.
