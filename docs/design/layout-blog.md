...
> VIS-5966 루틴 산출물 | AI 디자이너 작성 | 2026-09-01 | 태그 현황 업데이트 2026-09-15 (VIS-6729) | 앰버 버킷 정정·코드 현황 갱신 2026-09-15 (VIS-6758)
...
> **코드 현황(2026-09-16 업데이트):** `blog/page.tsx`의 `TAG_COLORS`에는 현재 사용 중인 블로그 포스트 필터 태그 21개 전부 명시됨(로컬 AI 추가). `blog/[slug]/page.tsx`(포스트 상세)는 향후 확장 대비 ~57개 항목 포함(사내 AI 채팅·Open WebUI 추가) — 두 파일 간 색상 일관성은 실제 사용 태그 기준으로 유지 중.
