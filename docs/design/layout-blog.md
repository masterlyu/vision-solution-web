...
> VIS-5966 루틴 산출물 | AI 디자이너 작성 | 2026-09-01 | 태그 현황 업데이트 2026-09-15 (VIS-6729) | 앰버 버킷 정정·코드 현황 갱신 2026-09-15 (VIS-6758) | primary 버킷 신규 태그 3건·수치 정정 2026-09-16 (VIS-6769) | [slug] 수량 오기 정정 61개 2026-09-16 (VIS-6783) | [slug] 신규 태그 29건 추가 90개 2026-09-17 (VIS-6834) | [slug] 신규 태그 3건 추가 93개 2026-09-17 (VIS-6848) | [slug] 신규 태그 2건 추가 95개 2026-09-17 (VIS-6868) | blog/page.tsx TAG_COLORS 21→95개 동기화 코드 현황 반영 2026-09-18 (VIS-6883)
...
| primary (AI·자동화) | AI 활용 · AI 솔루션 · AI 에이전트 · 업무 자동화 · 생성형 AI · 오픈소스 AI · AI 뉴스 · 로컬 AI · **AI 영상** · **소라 대안** | `primary/10` | `primary` |
...
> **코드 현황(2026-09-18 업데이트, VIS-6883):** `blog/page.tsx`와 `blog/[slug]/page.tsx` 모두 TAG_COLORS **95개**로 완전 동기화됨(VIS-6854에서 목록 페이지를 21→93개로 확장, 이후 VIS-6868에서 2건 추가로 양쪽 95개). 두 파일 간 내용 일치 확인 완료.
