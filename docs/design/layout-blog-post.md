...
**코드 현황(VIS-7046, 2026-09-21):** `TAG_COLORS` 총 98개 태그 매핑 완료. primary 1건(Google Antigravity) 추가(VIS-7046, 블로그 포스트 VIS-7030 발행분). 이전: VIS-6974에서 primary 1건(이미지 생성) 추가로 97개.
