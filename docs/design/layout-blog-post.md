...
**코드 현황(VIS-6974, 2026-09-19):** `TAG_COLORS` 총 97개 태그 매핑 완료. primary 1건(이미지 생성) 추가(VIS-6974). 이전: VIS-6901에서 primary 1건(컴퓨터 자동화) 추가로 96개.
