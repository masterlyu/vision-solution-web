...
> VIS-5989 루틴 산출물 | AI 디자이너 작성 | 2026-09-02 | SVG 이미지 텍스트 규칙 추가 2026-09-11 (VIS-6512) | 태그 링크 URL 규칙 정정 2026-09-15 (VIS-6716) | 태그 색상 버킷 현황 업데이트 2026-09-15 (VIS-6729)
...
| 빨강 (보안) | 보안 경고, 보안 점검, 웹 보안 진단 | `accent-red/10` | `accent-red` |
| primary (AI·자동화) | AI 활용, AI 솔루션, AI 에이전트, 업무 자동화, 생성형 AI, 오픈소스 AI, AI 뉴스 | `primary/10` | `primary` |
| 초록 (개발) | 개발 팁, 앱 개발 | `accent-green/10` | `accent-green` |
| 앰버 (홈페이지) | 홈페이지 제작, 유지보수, 홈페이지 진단 | `accent-amber/10` | `accent-amber` |
| 기본값(fallback) | 온라인마케팅, SNS 마케팅, SEO 최적화, 기타 미분류 | `primary/10` | `primary` |

> **코드 현황(2026-09-15):** `TAG_COLORS`에 명시된 태그는 기존 10개뿐. 신규 태그(`웹 보안 진단`, `AI 에이전트`, `업무 자동화` 등)는 fallback 처리 중 — 버킷 지정이 필요한 태그는 코드에도 추가 필요.
