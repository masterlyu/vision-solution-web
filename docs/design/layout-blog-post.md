...
> VIS-5989 루틴 산출물 | AI 디자이너 작성 | 2026-09-02 | SVG 이미지 텍스트 규칙 추가 2026-09-11 (VIS-6512) | 태그 링크 URL 규칙 정정 2026-09-15 (VIS-6716) | 태그 색상 버킷 현황 업데이트 2026-09-15 (VIS-6729) | TAG_COLORS 전면 확장 2026-09-15 (VIS-6734) | 주요 필터 태그 6개 추가 2026-09-15 (VIS-6738) | youtube-bgm SVG 제목 수정 2026-09-15 (VIS-6745)
...
**코드 현황(VIS-6738, 2026-09-15):** `TAG_COLORS` 총 60개 태그 매핑 완료. 주요 필터 태그 6개(`웹 보안 진단`, `홈페이지 진단`, `AI 뉴스`, `SEO 최적화`, `SNS 마케팅`, `온라인마케팅`) 추가.
...
| primary (AI·자동화) | `primary/10` | `primary` | AI 활용, AI 솔루션, **AI 뉴스**, 중소기업 AI, 오픈소스 AI, 업무 자동화, 무료 AI, 소상공인 AI, AI 에이전트, 무료 AI 도구, ChatGPT, 로컬 AI, 챗봇, AI 생산성, AI 도구, 오피스 자동화, 회의록 자동화, 클로드, Gemini, 구글 AI, 생성형 AI, 중소기업AI |
