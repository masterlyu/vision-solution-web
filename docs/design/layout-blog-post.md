...
**코드 현황(VIS-6769, 2026-09-16):** `TAG_COLORS` 총 61개 태그 매핑 완료. primary 버킷에 `사내 AI 채팅`, `Open WebUI` 신규 추가.

| 색상 버킷 | 배경 | 텍스트 | 포함 태그 |
|-----------|------|--------|---------|
| 파랑 (리뉴얼) | `accent-blue/10` | `accent-blue` | 리뉴얼 사례, 리뉴얼 비용, 홈페이지 리뉴얼 |
| 빨강 (보안) | `accent-red/10` | `accent-red` | 보안 경고, 보안 점검, 보안 진단, 웹 보안, 웹보안, **웹 보안 진단**, 중소기업 보안, 홈페이지 보안, 랜섬웨어, 해킹 방지, 해킹 방어, 사이버보안, KISA |
| primary (AI·자동화) | `primary/10` | `primary` | AI 활용, AI 솔루션, **AI 뉴스**, 중소기업 AI, 오픈소스 AI, 업무 자동화, 무료 AI, 소상공인 AI, AI 에이전트, 무료 AI 도구, ChatGPT, 로컬 AI, 챗봇, AI 생산성, AI 도구, 오피스 자동화, 회의록 자동화, 클로드, Gemini, 구글 AI, 생성형 AI, 중소기업AI, **사내 AI 채팅**, **Open WebUI** |
| 초록 (개발) | `accent-green/10` | `accent-green` | 개발 팁, 앱 개발, 오픈소스, 바이브코딩, 노코드 |
| 앰버 (홈페이지·비즈니스) | `accent-amber/10` | `accent-amber` | 홈페이지 제작, 유지보수, 중소기업, 소상공인, 마이크로소프트, SEO, **SEO 최적화**, **SNS 마케팅**, **온라인마케팅**, **홈페이지 진단**, 중소기업 마케팅, 소상공인 마케팅, 비용 절감, AI 비용 절감, 중소기업 AI 도입, 경쟁사 분석 |
