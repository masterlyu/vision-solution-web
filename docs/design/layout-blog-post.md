...
**코드 현황(VIS-6848, 2026-09-17):** `TAG_COLORS` 총 93개 태그 매핑 완료. 빨강 3건(AI공격·보안체크리스트·사기 예방), primary 16건(AI 글쓰기·AI홈페이지·AI챗봇·Colibri·GLM-5.2·유튜브 BGM·생성형AI·업무효율·업무자동화·AI 자동화·반복업무 제거·DeepSeek·Anthropic·GPT-6·지식관리·구조도 자동화), 앰버 10건(마케팅 도구·중소기업 지원사업·정부 지원·정부지원사업·GEO·AEO·검색최적화·디지털전환·온라인 쇼핑·매출 자동화) 신규 추가(VIS-6834). primary 1건(무료 도구), 앰버 2건(초보자 가이드·체크리스트) 추가(VIS-6848).
