...
**코드 현황(VIS-7066, 2026-09-21):** `TAG_COLORS` 총 104개 태그 매핑 완료. primary 4건(Flowise·AI 이미지 편집·SenseNova U1·포토샵 대안)·앰버 2건(모두의AI·4K 상품 사진) 추가(VIS-7066). 이전: VIS-7046에서 primary 1건(Google Antigravity) 추가로 98개.

| 색상 버킷 | 배경 | 텍스트 | 포함 태그 |
|-----------|------|--------|---------|
| 파랑 (리뉴얼) | `accent-blue/10` | `accent-blue` | 리뉴얼 사례, 리뉴얼 비용, 홈페이지 리뉴얼 |
| 빨강 (보안) | `accent-red/10` | `accent-red` | 보안 경고, 보안 점검, 보안 진단, 웹 보안, 웹보안, **웹 보안 진단**, 중소기업 보안, 홈페이지 보안, 랜섬웨어, 해킹 방지, 해킹 방어, 사이버보안, KISA, **AI공격**, **보안체크리스트**, **사기 예방** |
| primary (AI·자동화) | `primary/10` | `primary` | AI 활용, AI 솔루션, **AI 뉴스**, 중소기업 AI, 오픈소스 AI, 업무 자동화, 무료 AI, 소상공인 AI, AI 에이전트, 무료 AI 도구, ChatGPT, 로컬 AI, 챗봇, AI 생산성, AI 도구, 오피스 자동화, 회의록 자동화, 클로드, Gemini, 구글 AI, 생성형 AI, 중소기업AI, **사내 AI 채팅**, **Open WebUI**, **AI 글쓰기**, **AI홈페이지**, **AI챗봇**, **Colibri**, **GLM-5.2**, **유튜브 BGM**, **생성형AI**, **업무효율**, **업무자동화**, **AI 자동화**, **반복업무 제거**, **컴퓨터 자동화**, **DeepSeek**, **Anthropic**, **GPT-6**, **지식관리**, **구조도 자동화**, **무료 도구**, **AI 영상**, **소라 대안**, **이미지 생성**, **Google Antigravity**, **Flowise**, **AI 이미지 편집**, **SenseNova U1**, **포토샵 대안** |
| 초록 (개발) | `accent-green/10` | `accent-green` | 개발 팁, 앱 개발, 오픈소스, 바이브코딩, 노코드 |
| 앰버 (홈페이지·비즈니스) | `accent-amber/10` | `accent-amber` | 홈페이지 제작, 유지보수, 중소기업, 소상공인, 마이크로소프트, SEO, **SEO 최적화**, **SNS 마케팅**, **온라인마케팅**, **홈페이지 진단**, 중소기업 마케팅, 소상공인 마케팅, 비용 절감, AI 비용 절감, 중소기업 AI 도입, 경쟁사 분석, **마케팅 도구**, **중소기업 지원사업**, **정부 지원**, **정부지원사업**, **GEO**, **AEO**, **검색최적화**, **디지털전환**, **온라인 쇼핑**, **매출 자동화**, **초보자 가이드**, **체크리스트**, **모두의AI**, **4K 상품 사진** |
