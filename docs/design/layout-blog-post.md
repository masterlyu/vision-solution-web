...
**코드 현황(VIS-7077, 2026-09-21):** `TAG_COLORS` 총 122개 태그 매핑 완료. 보안 계열 미분류 13건 빨강 버킷 추가(VIS-7077, 109→122). 이전: VIS-7072 5건(104→109), VIS-7066 6건(98→104).

| 색상 버킷 | 배경 | 텍스트 | 포함 태그 |
|-----------|------|--------|---------|
| 파랑 (리뉴얼) | `accent-blue/10` | `accent-blue` | 리뉴얼 사례, 리뉴얼 비용, 홈페이지 리뉴얼 |
| 빨강 (보안) | `accent-red/10` | `accent-red` | 보안 경고, 보안 점검, 보안 진단, 웹 보안, 웹보안, **웹 보안 진단**, 중소기업 보안, 홈페이지 보안, 랜섬웨어, 해킹 방지, 해킹 방어, 사이버보안, KISA, **AI공격**, **보안체크리스트**, **사기 예방**, **보안**, **다크웹**, **사이버 공격**, **보안 취약점**, **AI 해킹**, **모의해킹**, **공공기관 보안**, **해킹 예방**, **AI 보안**, **AI 보안정책**, **침해사고**, **홈페이지 해킹**, **보안 헤더**, **취약점**, **데이터 보안** |
