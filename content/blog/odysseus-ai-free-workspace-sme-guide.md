---
title: "고객 데이터 안 새는 AI — Odysseus 30분 구축"
date: "2026-06-16"
tag: "AI 활용"
tags: "AI 활용,오픈소스 AI,데이터 보안,중소기업 AI,Odysseus,내부망 AI"
image: "/images/blog/odysseus-ai-free-workspace-sme-guide.svg"
summary: "직원이 ChatGPT에 고객 정보를 붙여넣을 때마다 데이터가 외부 서버로 나갑니다. GitHub 별 69,000개를 받은 오픈소스 Odysseus로 회사 전용 AI 서버를 직접 운영하면 데이터 보안과 비용 절감을 동시에 잡을 수 있습니다."
---

직원이 ChatGPT에 거래처 단가표를 붙여넣는 순간, 그 데이터는 OpenAI 서버로 올라갑니다. 고객 개인정보, 내부 기획안, 계약 조건도 마찬가지입니다.

최근 GitHub에서 화제가 된 오픈소스 프로젝트가 있습니다. 이름은 **Odysseus**. AGPL-3.0 라이선스, 완전 무료. 공개 2주 만에 GitHub 별 69,000개가 찍혔습니다.
...
**데이터 보안.** 고객 정보, 내부 기획안, 단가표를 ChatGPT에 입력하면 그 데이터는 OpenAI 서버로 올라갑니다. 개인정보보호법 관점에서 고객 정보를 동의 없이 제3자 서버로 전송하면 문제가 될 수 있습니다. 업종에 따라 영업 기밀이 경쟁사로 흘러가는 리스크도 있습니다.

**비용.** 직원 한 명당 월 $20(약 2만7천원), 10명이면 월 27만원, 1년이면 324만원. 업무용 Plus 기준입니다.

Odysseus는 이 두 가지를 동시에 해결합니다. 데이터는 내 서버 안에만 머물고, 구독료는 없습니다.
...
`http://localhost:7000`을 브라우저 주소창에 입력합니다. 처음 실행이면 계정 생성 화면이 뜹니다.
