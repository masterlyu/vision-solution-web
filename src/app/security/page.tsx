  ...
  return (
    <div className="flex items-end gap-2 justify-center">
      <svg viewBox="0 0 260 290" width="250" height="275" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="208" y="66" textAnchor="middle" style={{ fill: "var(--primary-foreground)" }} fontSize="22" fontWeight="bold" fontFamily="sans-serif">!</text>
        {/* Check badge bottom-left */}
        <circle cx="52" cy="215" r="22" fill="var(--accent-green)" opacity="0.9"/>
        <text x="52" y="223" textAnchor="middle" style={{ fill: "var(--primary-foreground)" }} fontSize="16" fontWeight="bold" fontFamily="sans-serif">✓</text>
        {/* Amber dot */}
