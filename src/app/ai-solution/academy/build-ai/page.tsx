...
const SECTIONS: Section[] = [
  ...
  { part: '8편', title: '자체 에이전트 만들기', desc: '회사 전용 에이전트 개발', star: true, ready: true,
    slidesKey: 'build-ai-part8-slides', notesKey: 'build-ai-part8-speaker-notes',
    lessons: [['22', 'Claude Agent SDK 기본 — Tool, Memory'], ['23', '실전 — 견적 자동화 에이전트 (메일→사양→BOM→견적서)']] },
  { part: '9편', title: '보안·권한·감사', desc: '엔터프라이즈급 보안', star: true, ready: true,
    slidesKey: 'build-ai-part9-slides', notesKey: 'build-ai-part9-speaker-notes',
