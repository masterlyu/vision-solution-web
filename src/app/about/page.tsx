  ...
  return (
    <main className="min-h-screen">
      ...
      <section style={{
        ...
        backgroundImage: 'radial-gradient(ellipse 80% 40% at 50% 0%, oklch(0.55 0.22 290 / 0.13), transparent)',
      }}>
          ...
          <FadeInSection>
            ...
            <div style={{ marginBottom: 18 }}>
              <span style={{
                ...
                background: 'oklch(0.55 0.22 290 / 0.18)', color: 'oklch(0.75 0.22 290)',
            ...
            <h1 style={{
              ...
              홈페이지 업체에 맡겼다가<br />
              <span style={{ color: 'oklch(0.75 0.22 290)' }}>연락 두절 된 적 있으신가요?</span>
            </h1>

            {/* Sub */}
            <p style={{
              color: 'oklch(0.60 0.01 270)', fontSize: '1.1rem', lineHeight: 1.7,
              maxWidth: 600, margin: '0 auto 38px',
            }}>
              Vision Solution은 그 경험을 바꾸고 싶어서 만들어진 회사입니다.<br />
              우리는 <strong style={{ color: 'oklch(0.97 0 0)' }}>"문의 주시면 검토 후 연락드리겠습니다"</strong> 대신,<br />
              <strong style={{ color: 'oklch(0.97 0 0)' }}>48시간 안에 리포트를 드립니다.</strong>
            </p>
            ...
            <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 24 }}>
              <Link href="/contact" style={{
                ...
                background: 'oklch(0.55 0.22 290)', color: '#fff',
              ...
              <Link href="/portfolio" style={{
                display: 'inline-flex', alignItems: 'center', gap: 8,
                background: 'transparent', color: 'oklch(0.75 0.22 290)',
                padding: '15px 36px', borderRadius: 10,
                fontSize: '1rem', fontWeight: 700, textDecoration: 'none',
                border: '1.5px solid oklch(0.55 0.22 290 / 0.55)',
              }}>
                포트폴리오 보기
              </Link>
            </div>

            <p style={{ fontSize: '0.82rem', color: 'oklch(0.60 0.01 270)' }}>
      ...
      <hr style={{ border: 'none', borderTop: '1px solid oklch(0.22 0.01 270)' }} />

      {/* ── SECTION 2: 수치 증거 ─────────────────────────────────────────── */}
      <section style={{ padding: '88px 24px', background: 'oklch(0.08 0.01 270)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <FadeInSection>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              <p style={{
                fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.16em',
                textTransform: 'uppercase', color: 'oklch(0.75 0.22 290)', marginBottom: 12,
              }}>실적 수치</p>
              <h2 style={{ fontSize: 'clamp(1.6rem, 4vw, 2.6rem)', fontWeight: 900, letterSpacing: '-0.02em' }}>
                숫자로 증명하는 Vision Solution
              </h2>
              <p style={{
                color: 'oklch(0.60 0.01 270)', marginTop: 14,
          ...
          <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
            ...
            <FadeInSection delay={0.05}>
              <div style={{
                background: 'oklch(0.12 0.01 270)', border: '1px solid oklch(0.22 0.01 270)',
                borderRadius: 16, padding: '36px 24px', textAlign: 'center', flex: 1, minWidth: 220,
                position: 'relative', overflow: 'hidden',
              }}>
                <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 3, background: 'linear-gradient(90deg, oklch(0.55 0.22 290), oklch(0.65 0.22 320))' }} />
                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 18 }}>
                  <LottiePlayer src="/lottie/ring.json" width={80} height={80} />
                </div>
                <div style={{ fontSize: 'clamp(2.8rem, 6vw, 4rem)', fontWeight: 900, letterSpacing: '-0.04em', color: 'oklch(0.75 0.22 290)', lineHeight: 1 }}>
                  <CountUpNumber value={200} suffix="+" />
                </div>
                <div style={{ fontSize: '1rem', fontWeight: 700, margin: '8px 0 6px' }}>완료한 프로젝트 수</div>
                <div style={{ fontSize: '0.82rem', color: 'oklch(0.60 0.01 270)' }}>중소기업·소상공인 고객사 기준</div>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay={0.10}>
              <div style={{
                ...
                <div style={{ fontSize: '0.82rem', color: 'oklch(0.60 0.01 270)' }}>약속한 날짜를 지킵니다</div>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay={0.15}>
              <div style={{
                ...
                <div style={{ fontSize: '0.82rem', color: 'oklch(0.60 0.01 270)' }}>납품 후 고객 설문 기준 / 5.0점 만점</div>
              </div>
            </FadeInSection>
          </div>
        </div>
      ...
      <section style={{ padding: '88px 24px', background: 'oklch(0.11 0.02 290)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 60, alignItems: 'center' }}>
            ...
            <FadeInSection>
              ...
              <h2 style={{ fontSize: 'clamp(1.6rem, 4vw, 2.6rem)', fontWeight: 900, letterSpacing: '-0.02em', marginBottom: 22 }}>
                "기술을 몰라도,<br />
                <span style={{ color: 'oklch(0.75 0.22 290)' }}>디지털에서 지면 안 된다"</span>
              </h2>
              <div style={{ color: 'oklch(0.60 0.01 270)', lineHeight: 1.7 }}>
            ...
            <FadeInSection delay={0.1}>
              <div style={{
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', padding: '16px 0', borderBottom: '1px solid oklch(0.22 0.01 270)' }}>
                  <span style={{ color: 'oklch(0.75 0.22 290)', fontWeight: 900, fontSize: '1.1rem', flexShrink: 0, marginTop: 2 }}>✦</span>
                  <div>
                    <p style={{ fontSize: '0.72rem', fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'oklch(0.75 0.22 290)', marginBottom: 6 }}>미션</p>
                    <p style={{ fontSize: '1rem', fontWeight: 700, lineHeight: 1.5 }}>
                      기술을 모르는 사장님도 디지털에서 이길 수 있도록, <strong style={{ color: 'oklch(0.75 0.22 290)' }}>공정한 기회를 만든다.</strong>
                    </p>
                  </div>
                </div>
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', padding: '16px 0' }}>
                  <span style={{ color: 'oklch(0.75 0.22 290)', fontWeight: 900, fontSize: '1.1rem', flexShrink: 0, marginTop: 2 }}>✦</span>
                  <div>
                    <p style={{ fontSize: '0.72rem', fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'oklch(0.75 0.22 290)', marginBottom: 6 }}>비전</p>
                    <p style={{ fontSize: '1rem', fontWeight: 700, lineHeight: 1.5 }}>
                      대한민국 중소기업 <strong style={{ color: 'oklch(0.75 0.22 290)' }}>10만 곳의</strong> 신뢰할 수 있는 디지털 파트너
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div style={{ marginTop: 28 }}>
                ...
                <p style={{ fontSize: '0.82rem', color: 'oklch(0.60 0.01 270)', textAlign: 'center', marginTop: 10 }}>
                  홈페이지 제작부터 AI 솔루션까지
                </p>
              </div>
            </FadeInSection>
      ...
      {/* ── SECTION 4: 팀 소개 ───────────────────────────────────────────── */}
      <section style={{ padding: '88px 24px', background: 'oklch(0.06 0.01 270)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <FadeInSection>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              <p style={{ fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'oklch(0.75 0.22 290)', marginBottom: 12 }}>팀 소개</p>
              <h2 style={{ fontSize: 'clamp(1.6rem, 4vw, 2.6rem)', fontWeight: 900, letterSpacing: '-0.02em' }}>
                각 분야 전문가가 한 팀으로 움직입니다
              </h2>
              <p style={{ color: 'oklch(0.60 0.01 270)', marginTop: 14, maxWidth: 540, marginLeft: 'auto', marginRight: 'auto' }}>
                기획 1명, 디자인 1명, 개발 2명이 각각 따로 일하는 구조가 아닙니다.<br />
                처음 상담부터 납품까지, <strong style={{ color: 'oklch(0.97 0 0)' }}>같은 팀이 끝까지 책임집니다.</strong>
              </p>
            </div>
          </FadeInSection>
            ...
            {[
              ...
              <FadeInSection key={item.title} delay={i * 0.05}>
                <div style={{
                  ...
                  <div style={{ fontSize: '0.82rem', color: 'oklch(0.75 0.22 290)', fontWeight: 700, marginBottom: 10 }}>{item.tagline}</div>
                  <p style={{ fontSize: '0.84rem', color: 'oklch(0.60 0.01 270)', lineHeight: 1.55 }}>{item.desc}</p>
                </div>
              </FadeInSection>
            ))}
          </div>
      ...
      <section style={{ padding: '88px 24px', background: 'oklch(0.08 0.01 270)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <FadeInSection>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              <p style={{ fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'oklch(0.75 0.22 290)', marginBottom: 12 }}>우리가 다른 이유</p>
              <h2 style={{ fontSize: 'clamp(1.6rem, 4vw, 2.6rem)', fontWeight: 900, letterSpacing: '-0.02em' }}>
                "맡기고 나서도 안심"이 가능한 이유
              </h2>
            </div>
            ...
            {[
              ...
              <FadeInSection key={item.num} delay={i * 0.07}>
                <div style={{
                  ...
                  <div style={{ fontSize: '2.8rem', fontWeight: 900, color: 'oklch(0.55 0.22 290 / 0.35)', letterSpacing: '-0.04em', marginBottom: 8 }}>{item.num}</div>
                  <div style={{ fontSize: '1.1rem', fontWeight: 800, marginBottom: 10 }}>{item.title}</div>
                  <p style={{ fontSize: '0.9rem', color: 'oklch(0.60 0.01 270)', lineHeight: 1.6 }}>{item.desc}</p>
                </div>
              </FadeInSection>
            ))}
          </div>
      ...
      <section style={{ padding: '88px 24px', background: 'oklch(0.11 0.02 290)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <FadeInSection>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              <p style={{ fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'oklch(0.75 0.22 290)', marginBottom: 12 }}>연혁</p>
              <h2 style={{ fontSize: 'clamp(1.6rem, 4vw, 2.6rem)', fontWeight: 900, letterSpacing: '-0.02em' }}>
          ...
          <div style={{ maxWidth: 720, margin: '0 auto', position: 'relative' }}>
            ...
            <div style={{
              ...
              background: 'linear-gradient(to bottom, oklch(0.55 0.22 290), oklch(0.55 0.22 290 / 0.1))',
            }} />

            {[
              { year: '2020', title: '창업 — "중소기업 디지털 불평등 해소" 미션 선포', desc: '웹사이트 제작 전문으로 시작. 중소기업이 공정하게 디지털 경쟁에 참여할 수 있는 환경을 만들겠다는 비전 수립.' },
              ...
              <FadeInSection key={item.year} delay={i * 0.06}>
                <div style={{ display: 'flex', gap: 0, padding: '20px 0', position: 'relative' }}>
                  <div style={{
                    ...
                    fontWeight: 800, fontSize: '0.9rem', color: 'oklch(0.75 0.22 290)', paddingTop: 2,
                  }}>{item.year}</div>
                  <div style={{
                    width: 14, height: 14, borderRadius: '50%',
                    background: item.accent ? 'linear-gradient(135deg, oklch(0.55 0.22 290), oklch(0.65 0.22 320))' : 'oklch(0.55 0.22 290)',
                    border: '2px solid oklch(0.08 0.01 270)',
                  ...
                  <div style={{ paddingLeft: 20, flex: 1 }}>
                    <strong style={{
                      ...
                      color: item.accent ? 'oklch(0.75 0.22 290)' : undefined,
                    }}>{item.title}</strong>
                    <p style={{ fontSize: '0.86rem', color: 'oklch(0.60 0.01 270)', lineHeight: 1.55 }}>{item.desc}</p>
                  </div>
                </div>
              </FadeInSection>
            ))}
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <FadeInSection>
            <div style={{ textAlign: 'center', marginBottom: 48 }}>
              <p style={{ fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'oklch(0.75 0.22 290)', marginBottom: 12 }}>고객 신뢰</p>
              ...
              <FadeInSection key={badge.title} delay={i * 0.05}>
                <div style={{
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '0.78rem', color: 'oklch(0.60 0.01 270)' }}>{badge.sub}</span>
                  </div>
                </div>
              </FadeInSection>
            ))}
          ...
          {/* Review cards */}
          <FadeInSection delay={0.1}>
            <p style={{ fontSize: '0.72rem', fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'oklch(0.60 0.01 270)', marginBottom: 20, textAlign: 'center' }}>실제 고객 후기</p>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 18 }}>
              {[
                ...
                <div key={i} style={{ background: 'oklch(0.12 0.01 270)', border: '1px solid oklch(0.22 0.01 270)', borderRadius: 14, padding: 28 }}>
                  <div style={{ fontSize: '1.6rem', color: 'oklch(0.75 0.22 290)', marginBottom: 10, lineHeight: 1 }}>"</div>
                  <p style={{ fontSize: '0.93rem', lineHeight: 1.65, fontStyle: 'italic', marginBottom: 16 }}>{review.body}</p>
                  <p style={{ fontSize: '0.82rem', color: 'oklch(0.60 0.01 270)', fontWeight: 600 }}>— {review.author}</p>
                </div>
              ))}
            </div>
            {/* Carousel dots */}
            <div style={{ display: 'flex', gap: 6, justifyContent: 'center', marginTop: 20 }}>
              <span style={{ width: 24, height: 6, borderRadius: 3, background: 'oklch(0.55 0.22 290)', display: 'block' }} />
              <span style={{ width: 6, height: 6, borderRadius: 3, background: 'oklch(0.22 0.01 270)', display: 'block' }} />
              <span style={{ width: 6, height: 6, borderRadius: 3, background: 'oklch(0.22 0.01 270)', display: 'block' }} />
            </div>
          </FadeInSection>
        </div>
      ...
      {/* ── SECTION 8a: 고객사 로고 띠 ──────────────────────────────────── */}
      <section style={{ padding: '56px 24px', background: 'oklch(0.08 0.01 270)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <FadeInSection>
            <p style={{ fontSize: '0.72rem', fontWeight: 800, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'oklch(0.60 0.01 270)', textAlign: 'center', marginBottom: 28 }}>신뢰하는 고객사</p>
            <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center' }}>
              {['고객사 A', '고객사 B', '고객사 C', '고객사 D', '고객사 E', '고객사 F', '고객사 G', '고객사 H'].map(name => (
                <div key={name} style={{
                  ...
                  fontSize: '0.75rem', fontWeight: 700, color: 'oklch(0.60 0.01 270)',
            ...
            <p style={{ fontSize: '0.78rem', color: 'oklch(0.60 0.01 270)', textAlign: 'center', marginTop: 20 }}>
      ...
      <section style={{ padding: '88px 24px', background: 'oklch(0.11 0.02 290)' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          <FadeInSection>
            <div style={{ textAlign: 'center', marginBottom: 48 }}>
              <p style={{ fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'oklch(0.75 0.22 290)', marginBottom: 12 }}>자주 묻는 질문</p>
          ...
          {[
            ...
            <FadeInSection key={i} delay={i * 0.05}>
              <div style={{ borderBottom: i < 4 ? '1px solid oklch(0.22 0.01 270)' : 'none', padding: '22px 0' }}>
                <div style={{ fontSize: '1rem', fontWeight: 700, marginBottom: 10, display: 'flex', gap: 10 }}>
                  <span style={{ color: 'oklch(0.75 0.22 290)', flexShrink: 0 }}>Q{i + 1}</span>
                  {item.q}
                </div>
                <p style={{ fontSize: '0.9rem', color: 'oklch(0.60 0.01 270)', lineHeight: 1.65, paddingLeft: 28 }}>{item.a}</p>
              </div>
            </FadeInSection>
          ))}
        </div>
      ...
      <section style={{
        ...
        textAlign: 'center',
        background: 'oklch(0.06 0.01 270)',
        backgroundImage: 'radial-gradient(ellipse 90% 60% at 50% 0%, oklch(0.55 0.22 290 / 0.18), transparent)',
      }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <FadeInSection>
            {/* Urgency badge */}
            <div style={{ marginBottom: 20 }}>
              <span style={{
                ...
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: 'oklch(0.75 0.22 290)', display: 'inline-block' }} />
                지금 이 순간도
              </span>
            </div>
            ...
            <h2 style={{
              ...
              경쟁사 홈페이지가<br />
              <span style={{ color: 'oklch(0.75 0.22 290)' }}>고객을 가로채고 있을 수 있습니다.</span>
            </h2>

            <p style={{ color: 'oklch(0.60 0.01 270)', maxWidth: 520, margin: '0 auto 44px', fontSize: '1.05rem', lineHeight: 1.7 }}>
            ...
            <p style={{ fontSize: '0.84rem', color: 'oklch(0.60 0.01 270)' }}>
