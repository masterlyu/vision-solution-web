...
function BeforeAfterSlider() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute bottom-2.5 left-3 z-10 text-xs font-black uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-foreground/8 text-muted-foreground">Before</span>
