...
const DOWNLOADS: Record<string, Entry> = {
  ...
  'build-ai-part1-slides': {
    file: 'src/storage/academy/build-ai-part1-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part1-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part1-speaker-notes': {
    file: 'src/storage/academy/build-ai-part1-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part1-speaker-notes.pdf',
    mime: PDF_MIME,
  },
  'build-ai-part2-slides': {
    file: 'src/storage/academy/build-ai-part2-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part2-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part2-speaker-notes': {
    file: 'src/storage/academy/build-ai-part2-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part2-speaker-notes.pdf',
    mime: PDF_MIME,
  },
  'build-ai-part3-slides': {
    file: 'src/storage/academy/build-ai-part3-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part3-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part3-speaker-notes': {
    file: 'src/storage/academy/build-ai-part3-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part3-speaker-notes.pdf',
    mime: PDF_MIME,
  },
  'build-ai-part4-slides': {
    file: 'src/storage/academy/build-ai-part4-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part4-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part4-speaker-notes': {
    file: 'src/storage/academy/build-ai-part4-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part4-speaker-notes.pdf',
    mime: PDF_MIME,
  },
  'build-ai-part5-slides': {
    file: 'src/storage/academy/build-ai-part5-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part5-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part5-speaker-notes': {
    file: 'src/storage/academy/build-ai-part5-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part5-speaker-notes.pdf',
    mime: PDF_MIME,
  },
  'build-ai-part6-slides': {
    file: 'src/storage/academy/build-ai-part6-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part6-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part6-speaker-notes': {
    file: 'src/storage/academy/build-ai-part6-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part6-speaker-notes.pdf',
    mime: PDF_MIME,
  },
  'build-ai-part7-slides': {
    file: 'src/storage/academy/build-ai-part7-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part7-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part7-speaker-notes': {
    file: 'src/storage/academy/build-ai-part7-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part7-speaker-notes.pdf',
    mime: PDF_MIME,
  },
  'build-ai-part8-slides': {
    file: 'src/storage/academy/build-ai-part8-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part8-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part8-speaker-notes': {
    file: 'src/storage/academy/build-ai-part8-speaker-notes.pdf',
  ...
  'build-ai-part10-slides': {
    file: 'src/storage/academy/build-ai-part10-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part10-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part10-speaker-notes': {
    file: 'src/storage/academy/build-ai-part10-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part10-speaker-notes.pdf',
    mime: PDF_MIME,
  },
  'build-ai-part11-slides': {
    file: 'src/storage/academy/build-ai-part11-slides.pptx',
    filename: 'visionc-enterprise-build-ai-part11-slides.pptx',
    mime: PPTX_MIME,
  },
  'build-ai-part11-speaker-notes': {
    file: 'src/storage/academy/build-ai-part11-speaker-notes.pdf',
    filename: 'visionc-enterprise-build-ai-part11-speaker-notes.pdf',
    mime: PDF_MIME,
  },
