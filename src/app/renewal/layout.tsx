...
const title = '홈페이지 리뉴얼 비용·기간 총정리'
const description = '낡은 홈페이지 때문에 고객이 떠납니다. URL 입력 후 48시간 내 무료 진단. 리뉴얼 비용 투명 공개.'

export const metadata: Metadata = {
  title,
  description,
  keywords: ['홈페이지 리뉴얼', '홈페이지 리뉴얼 비용', '중소기업 홈페이지 리뉴얼', '홈페이지 리뉴얼 기간', '비전솔루션'],
