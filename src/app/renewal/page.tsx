...
const stats = [
  ...
  { value: '140%', label: 'SEO 개편 3개월 내 유입 증가' },
]

const solutions = [
  { icon: Zap,        title: '속도 최적화',       desc: '로딩 3초 → 0.8초. 고객이 기다리지 않습니다.' },
  { icon: Smartphone, title: '모바일 퍼스트 설계', desc: '스마트폰으로 봐도 버튼이 크고 글씨가 선명합니다.' },
  { icon: Target,     title: '전환율 UX 재설계',  desc: '방문자가 자연스럽게 "문의하기"를 누르게 됩니다.' },
  { icon: Search,     title: 'SEO 구조 개편',     desc: '구글·네이버에서 경쟁사보다 먼저 노출됩니다.' },
]

const steps = [
  { num: '01', title: '무료 현황 진단', duration: '2일',   desc: '현재 사이트 속도·SEO·UX 분석 리포트. 비용 없음.' },
  { num: '02', title: '기획·설계',     duration: '1주',   desc: '사이트맵, 와이어프레임, 디자인 시안 3종 제시 후 확정.' },
  { num: '03', title: '개발·이전',     duration: '2~3주', desc: '데이터 손실 없이 기존 콘텐츠 마이그레이션.' },
  { num: '04', title: '검수·배포',     duration: '3일',   desc: '크로스 브라우저 QA 완료 후 도메인 무중단 전환.' },
]

const plans = [
  { name: '기본형', price: '100만원대~', items: ['디자인 리뉴얼', '모바일 최적화', '속도 개선'], highlight: false },
  { name: '표준형', price: '200만원대~', items: ['기본형 전체', 'SEO 구조 개편', 'CTA 재설계'], highlight: true },
  { name: '확장형', price: '300만원대~', items: ['표준형 전체', '콘텐츠 전략', '분석 도구 연동'], highlight: false },
]

const faqs = [
  { q: '리뉴얼하면 기존 고객 데이터나 SEO가 날아가지 않나요?', a: '기존 URL 구조를 최대한 유지하고, 301 리다이렉트로 검색 순위를 보전합니다. 고객 DB와 게시물 데이터는 마이그레이션 전 전수 백업 후 이전합니다.' },
