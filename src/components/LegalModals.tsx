  ...
  return (
    <>
      <button
        ...
        className="text-muted-foreground text-xs hover:text-foreground/60 transition-colors"
      >
        개인정보처리방침
      </button>
      ...
      <Dialog open={open === 'privacy'} onOpenChange={v => setOpen(v ? 'privacy' : null)}>
        <DialogContent className="max-w-2xl bg-card border-border text-card-foreground">
          <DialogHeader>
            <DialogTitle className="text-foreground text-lg">개인정보처리방침</DialogTitle>
          </DialogHeader>
          <ScrollArea className="h-[60vh] pr-4">
            <div className="space-y-5 text-sm leading-relaxed">
              <p className="text-muted-foreground text-xs">시행일: 2025년 1월 1일</p>

              <section>
                <h3 className="text-foreground font-semibold mb-2">제1조 (개인정보의 처리 목적)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제2조 (수집하는 개인정보 항목)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제3조 (개인정보의 처리 및 보유 기간)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제4조 (개인정보의 제3자 제공)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제5조 (개인정보 처리의 위탁)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제6조 (정보주체의 권리·의무)</h3>
                ...
                <p className="mt-2">위 권리 행사는 <strong className="text-foreground">biztalktome@gmail.com</strong>으로 이메일 문의 주시면 처리해드립니다.</p>
              </section>

              <section>
                <h3 className="text-foreground font-semibold mb-2">제7조 (개인정보의 안전성 확보 조치)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제8조 (개인정보 보호책임자)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제9조 (개인정보 처리방침 변경)</h3>
      ...
      <Dialog open={open === 'terms'} onOpenChange={v => setOpen(v ? 'terms' : null)}>
        <DialogContent className="max-w-2xl bg-card border-border text-card-foreground">
          <DialogHeader>
            <DialogTitle className="text-foreground text-lg">이용약관</DialogTitle>
          </DialogHeader>
          <ScrollArea className="h-[60vh] pr-4">
            <div className="space-y-5 text-sm leading-relaxed">
              <p className="text-muted-foreground text-xs">시행일: 2025년 1월 1일</p>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제1조 (목적)</h3>
                <p>이 약관은 비젼솔루션(이하 "회사")이 운영하는 visionc.co.kr(이하 "사이트")에서 제공하는 서비스의 이용 조건 및 절차, 회사와 이용자 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
              </section>

              <section>
                <h3 className="text-foreground font-semibold mb-2">제2조 (용어의 정의)</h3>
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제3조 (약관의 효력 및 변경)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제4조 (서비스 이용)</h3>
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제5조 (이용자의 의무)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제6조 (서비스 제공의 제한)</h3>
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제7조 (면책조항)</h3>
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <section>
                <h3 className="text-foreground font-semibold mb-2">제8조 (지식재산권)</h3>
                <p>사이트 내 콘텐츠, 디자인, 코드 등 모든 저작물의 지식재산권은 회사에 귀속됩니다. 이용자는 회사의 명시적인 사전 동의 없이 이를 복제, 배포, 수정하여서는 안 됩니다.</p>
              </section>

              <section>
                <h3 className="text-foreground font-semibold mb-2">제9조 (준거법 및 관할법원)</h3>
                <p>이 약관에 관한 분쟁은 대한민국 법률에 따르며, 소송은 회사 소재지를 관할하는 법원에 제기합니다.</p>
              </section>

              <section>
                <h3 className="text-foreground font-semibold mb-2">제10조 (문의)</h3>
